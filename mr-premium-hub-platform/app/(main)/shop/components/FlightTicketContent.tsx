...
const SECTIONS = [
  ...
  },
  {
    ...
    type: "text" as const,
    paragraphs: [
      "تعداد سایت‌هایی که در لیست بالا می‌بینیم و مستر پریمیوم هاب می‌تواند از آن‌ها بلیط هواپیمای خارجی خریداری کند، ممکن است تغییر کند. به عنوان مثال ممکن است در یک برهه زمانی، خرید بلیط هواپیما از وبسایتی ممکن نباشد یا در آینده وبسایتی به لیست بالا اضافه شود.",
  ...
  },
  {
    ...
    type: "text" as const,
    paragraphs: [
      "بله، خرید اینترنتی بلیط هواپیما از طریق مستر پریمیوم هاب امکان‌پذیر است. برای خرید بلیط هواپیما به صورت آنلاین کافی است به پنل کاربری خودتان در مستر پریمیوم هاب مراجعه کنید و سفارش خرید بلیط پرواز خارجی را ثبت کنید.",
    ],
  },
  {
    id: "how",
    title: "نحوه خرید بلیط هواپیما از طریق مستر پریمیوم هاب چگونه است؟",
    type: "text" as const,
    paragraphs: [
      "برای خرید بلیط پروازهای خارجی خود ابتدا در وبسایت مستر پریمیوم هاب حساب کاربری بسازید و در ادامه با استفاده از پنل کاربری خود، سفارش خرید بلیط هواپیما را ثبت کنید. سفارش شما طی ۱ تا ۳ ساعت بررسی می‌شود و در صورت امکان انجام خواهد شد.",
    ],
  },
  {
    id: "refund",
    ...
    type: "text" as const,
    paragraphs: [
      "بله، امکان ریفاند مبلغ پرواز خارجی هنگام کنسلی یا تغییر زمان پرواز در شرایط خاصی وجود دارد. برای استرداد هزینه کنسلی بلیط پرواز ابتدا از طریق پنل کاربری خود در مستر پریمیوم هاب ثبت سفارش کنید تا کارشناسان ما سفارش شما را بررسی کنند.",
    ],
  },
];
