      ...
      <div className="flex items-center justify-between">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="bg-white text-gray-600 px-4 py-3 rounded-lg flex items-center justify-between gap-3 hover:bg-gray-50 transition-all duration-200 min-w-[200px] shadow-sm hover:shadow-md"
          >
            <span className="text-sm font-medium text-right">
              {selectedSortLabel}
            </span>
            <svg
              className={`w-5 h-5 shrink-0 transition-transform duration-300 text-gray-500 ${
