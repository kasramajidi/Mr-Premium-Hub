          ...
          <div className="flex items-center justify-end flex-1">
            <div className="flex flex-col justify-center text-right">
              ...
              <p className="text-white/90 text-[10px] sm:text-xs md:text-sm leading-5 sm:leading-6">
                مستر پریمیوم هاب با تمرکز بر خدمات ارزی و پرداخت ارزی، نقد درآمد پی‌پال، پرداخت با مسترکارت، ویزا و سفارت، آزمون‌های بین‌المللی و سفر را با امنیت و سرعت انجام می‌دهد. رضایت مشتریان و شفافیت در معاملات از اهداف ماست.
              </p>
            </div>
          </div>
