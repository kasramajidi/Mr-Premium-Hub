...
export const metadata: Metadata = {
  ...
  description:
    "مستر پریمیوم هاب (Mr Premium Hub) - نقد درآمد پی‌پال، پرداخت با مسترکارت، پرداخت هزینه ویزا و سفارت، ثبت نام آزمون‌های بین‌المللی، خرید بلیت هواپیما و هتل. تماس: ۰۲۱-۹۱۳۲۰۷۰۰ | support@tehranpayment.com",
  keywords: [
    "نقد درآمد ارزی",
    "پرداخت پی‌پال",
    "پرداخت مستر کارت",
