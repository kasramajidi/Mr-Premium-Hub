...
export default function WalletSection() {
  ...
  const cards = [
    { title: "موجودی بلوکه شده", value: 0, action: null as string | null, href: null as string | null },
    {
    ...
    { title: "موجودی کیف پول", value: 0, action: null as string | null, href: null as string | null },
  ];
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        {cards.map((card) => (
          ...
          >
            ...
            <p className="mt-2 text-lg font-bold text-gray-900">{formatRial(card.value)}</p>
